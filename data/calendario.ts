...
export const CALENDARIO: CorsoCalendario[] = [
  ...
  {
    id: 24,
    titolo: 'Formazione Lavoratori',
    slug: 'formazione-dei-lavoratori-parte-generale',
    categoria: 'obbligatoria',
    data: '2026-08-10',
    orario: '09:00 - 13:00',
    sede: 'Vittoria (RG) — Sede Alètheia',
  ...
  },
  {
    id: 25,
    titolo: 'Corso RSPP',
    slug: 'rspp-datore-di-lavoro-modulo-comune',
    categoria: 'obbligatoria',
    data: '2026-08-10',
    orario: '14:00 - 22:00',
    sede: 'Vittoria (RG) — Sede Alètheia',
  ...
  // ── Corsi con pagina dedicata (già creati, non generici) ────
  {
    id: 26,
