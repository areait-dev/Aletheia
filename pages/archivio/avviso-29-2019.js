...
export default function AvvisoAvviso292019() {
  const dati = archivioIndex['avviso-29-2019'] || {};
  const descr = descrizioniArchivio['avviso-29-2019'] || {};
