...
export default function AvvisoFeampMisura1292023() {
  const dati = archivioIndex['feamp-misura-1-29-2023'] || {};
  const descr = descrizioniArchivio['feamp-misura-1-29-2023'] || {};
      ...
      <main className="bg-white dark:bg-gray-900 min-h-screen pt-40 pb-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-50 mb-8">
            {descr.titolo || 'Feamp Misura 1 29 2023'}
          </h1>
