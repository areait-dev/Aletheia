...
export default function AvvisoAvviso22018CorsoDiCucina() {
  const dati = archivioIndex['avviso-2-2018/corso-di-cucina'] || {};
  const descr = descrizioniArchivio['avviso-2-2018/corso-di-cucina'] || {};
