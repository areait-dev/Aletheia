...
export default function AvvisoAvviso72023() {
  const dati = archivioIndex['avviso-7-2023'] || {};
  const descr = descrizioniArchivio['avviso-7-2023'] || {};
