...
export default function AvvisoAvviso332019() {
  const dati = archivioIndex['avviso-33-2019'] || {};
  const descr = descrizioniArchivio['avviso-33-2019'] || {};
