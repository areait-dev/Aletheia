...
export default function AvvisoMisuraPsr11WorkshopStrategieMarketing() {
  const dati = archivioIndex['misura-psr-1-1/workshop-strategie-marketing'] || {};
  const descr = descrizioniArchivio['misura-psr-1-1/workshop-strategie-marketing'] || {};
      ...
      <main className="bg-white dark:bg-gray-900 min-h-screen pt-40 pb-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-50 mb-8">
            {descr.titolo || 'Workshop Strategie Marketing'}
          </h1>
