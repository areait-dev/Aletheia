...
export default function AvvisoCorsiSettoreAgricoloEAgroalimentare() {
  const dati = archivioIndex['corsi-settore-agricolo-e-agroalimentare'] || {};
  const descr = descrizioniArchivio['corsi-settore-agricolo-e-agroalimentare'] || {};
      ...
      <main className="bg-white dark:bg-gray-900 min-h-screen pt-40 pb-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-50 mb-8">
            {descr.titolo || 'Corsi Settore Agricolo E Agroalimentare'}
          </h1>
