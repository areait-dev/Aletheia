...
const corsi = [
  {
    slug: 'certificazioni-informatiche',
    subKey: 'certificazioni-informatiche',
    ...
    price: 'Da € 150,00',
    priceColor: '#0F172A',
    description: 'Certificazioni ICDL e AICA riconosciute a livello internazionale. Siamo Test Center AICA accreditato (n. AKHF0001). Valide per concorsi pubblici.',
  },
  {
    slug: 'corsi-qualificati',
    subKey: 'certificazione',
    ...
    price: '€ 1.500 - € 5.000',
    priceColor: '#0F172A',
    description: "Percorsi accreditati dalla Regione Siciliana per l'ottenimento di qualifiche professionali riconosciute a livello nazionale.",
  },
  {
    slug: 'ecm',
    subKey: 'ecm',
    ...
    price: 'Quota partecipazione',
    priceColor: '#0F172A',
    description: 'Educazione Continua in Medicina. Percorsi accreditati ECM per professionisti sanitari, con crediti formativi riconosciuti dal Ministero della Salute.',
  },
  {
    slug: 'corsi-pa',
    subKey: 'corsi-pa',
    ...
    priceColor: '#008C95',
    description: 'Formazione su misura per dipendenti della Pubblica Amministrazione: digitalizzazione, appalti, diritto amministrativo e molto altro.',
  },
];
...
export default function FormazioneProfessionaleSpecialistica() {
  return (
    <>
      <Head>
        <title>Formazione Professionale e Specialistica - Alètheia Srl</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content="Percorsi per sviluppare competenze avanzate: ICDL, corsi qualificati, formazione continua e corsi per la Pubblica Amministrazione. Test Center AICA accreditato."
        />
      ...
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p className="fade-up fade-up-2" style={{
            ...
            Percorsi per sviluppare competenze avanzate e ottenere certificazioni riconosciute a livello nazionale e internazionale.
          </p>
          ...
          <div style={{ display: 'flex', gap: '2.5rem', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: '260px' }}>
              ...
              <h2 className="text-slate-900 dark:text-white" style={{ fontSize: 'clamp(1.4rem, 2.5vw, 1.9rem)', fontWeight: 900, marginBottom: '1rem', lineHeight: 1.25 }}>
                Competenze{' '}
                <span style={{ color: '#008C95' }}>riconosciute a livello internazionale</span>
              </h2>
              <p className="text-slate-600 dark:text-gray-300" style={{ fontSize: '0.95rem', lineHeight: 1.85, margin: 0 }}>
                La Formazione Professionale e Specialistica comprende percorsi per acquisire competenze tecniche avanzate, ottenere qualifiche riconosciute e certificazioni internazionali. Alètheia Srl è Test Center AICA accreditato per le certificazioni ICDL e ente accreditato dalla Regione Siciliana per il rilascio di qualifiche professionali.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0F172A 0%, #134E4A 100%)', padding: '5rem 0' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.65)', maxWidth: '720px', margin: '0 auto 2.5rem', lineHeight: 1.75 }}>
            Il nostro team è a disposizione per guidarti nella scelta del percorso formativo più adatto ai tuoi obiettivi.
          </p>
