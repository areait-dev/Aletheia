...
const corsi = [
  {
    ...
    price: 'Gratuito',
    priceColor: '#10B981',
    description: 'Corso obbligatorio conforme al D.Lgs. 81/08. Copre prevenzione incendi, primo soccorso e gestione delle emergenze.',
  },
  {
    slug: 'decreto-attrezzature',
    subKey: 'decreto-attrezzature',
    ...
    price: '€ 250,00',
    priceColor: '#0F172A',
    description: "Formazione obbligatoria per l'utilizzo sicuro delle attrezzature di lavoro ai sensi del D.Lgs. 81/08 e Accordo Stato-Regioni.",
  },
  {
    slug: 'fitosanitario',
    subKey: 'fitosanitario',
    ...
    price: '€ 300,00',
    priceColor: '#0F172A',
    description: 'Corso obbligatorio per il rilascio del patentino fitosanitario ai sensi del D.Lgs. 150/2012 per uso prodotti fitosanitari.',
  },
  {
    slug: 'sicurezza-alimentare',
    subKey: 'sicurezza-alimentare',
    title: 'Sicurezza Alimentare (HACCP)',
    icon: 'fas fa-utensils',
    duration: '8 ore',
    modality: 'Aula / Online',
    price: '€ 150,00',
    priceColor: '#0F172A',
    description: 'Corso HACCP obbligatorio per operatori del settore alimentare. Corretta gestione igienico-sanitaria degli alimenti.',
  },
];
...
export default function FormazioneObbligatoria() {
  return (
    <>
      <Head>
        <title>Formazione Obbligatoria - Alètheia Srl</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content="Corsi obbligatori per legge: sicurezza sul lavoro, HACCP, decreto attrezzature, patentino fitosanitario. Attestati riconosciuti a livello nazionale."
        />
      ...
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p className="fade-up fade-up-2" style={{
            ...
            Corsi obbligatori per legge per lavoratori, aziende e professionisti. Attestati riconosciuti a livello nazionale.
          </p>
          ...
          <div style={{ display: 'flex', gap: '2.5rem', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: '260px' }}>
              ...
              <h2 className="text-slate-900 dark:text-white" style={{ fontSize: 'clamp(1.4rem, 2.5vw, 1.9rem)', fontWeight: 900, marginBottom: '1rem', lineHeight: 1.25 }}>
                Attestati{' '}
                <span style={{ color: '#008C95' }}>conformi alla normativa</span>
              </h2>
              <p className="text-slate-600 dark:text-gray-300" style={{ fontSize: '0.95rem', lineHeight: 1.85, margin: 0 }}>
                La Formazione Obbligatoria comprende tutti i corsi previsti dalla normativa italiana ed europea che devono essere obbligatoriamente seguiti da lavoratori, datori di lavoro e professionisti. Alètheia Srl eroga questi corsi in modalità aula e online (FAD), rilasciando attestati conformi all&apos;Accordo Stato-Regioni e alle normative di settore.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-100 dark:border-teal-900/40" style={{
            ...
            <p className="text-teal-900 dark:text-teal-200" style={{ margin: 0, fontSize: '0.9rem', fontWeight: 600, lineHeight: 1.6 }}>
              Tutti i nostri attestati sono conformi all&apos;Accordo Stato-Regioni e riconosciuti su tutto il territorio nazionale.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0F172A 0%, #134E4A 100%)', padding: '5rem 0' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.65)', maxWidth: '720px', margin: '0 auto 2.5rem', lineHeight: 1.75 }}>
            Il nostro team è a disposizione per guidarti nella scelta del corso più adatto alle tue esigenze normative.
          </p>
