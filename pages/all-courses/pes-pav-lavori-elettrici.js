        ...
        <div className="container">
          <div className="cp-page-grid">
            ...
            {/* SIDEBAR PREZZO: colonna destra sticky su desktop (lg+), full-width in flusso su mobile/tablet.
                Cambia in base alla variante selezionata nello switch qui sopra (customContent include il
                suggerimento per passare all'altra variante, prima renderizzato come children). */}
