  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        /* Layout a due colonne guidato da grid-template-areas: su mobile le tre aree si impilano
           nell'ordine hero -> price -> tabs (box prezzo subito sotto la scheda tecnica, prima delle tab).
           Da lg in su, "price" occupa la colonna destra su entrambe le righe e resta sticky. */
        .cp-page-grid {
          display: grid;
        ...
        @media (min-width: 992px) {
          .cp-page-grid {
            ...
            gap: 4rem; /* distacco netto tra contenuto e sidebar su desktop (gap-16) */
          }
        }
          ...
          <div className="cp-page-grid">
            ...
            <div className="cp-hero-area">
              <nav style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.78rem', marginBottom: '1.25rem', flexWrap: 'wrap' }}>
                ...
                <Link href="/all-courses?categoria=decreto-attrezzature" className="text-slate-500 dark:text-gray-400" style={{ textDecoration: 'none' }}>Decreto Attrezzature</Link>
                <span className="text-slate-300 dark:text-gray-600">/</span>
                <span className="text-slate-600 dark:text-gray-300">Addetti alla Conduzione di Carriponte</span>
              </nav>
              ...
              <div style={{ background: 'linear-gradient(135deg, #0F172A 0%, #134E4A 100%)', borderRadius: '1.75rem', padding: 'clamp(1.75rem, 4vw, 2.75rem)', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                  <span style={{ display: 'inline-block', fontSize: '0.68rem', fontWeight: 800, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#6EE7B7', background: 'rgba(16,185,129,0.12)', border: '1px solid rgba(16,185,129,0.25)', padding: '0.35rem 0.9rem', borderRadius: '999px', marginBottom: '1.25rem' }}>
                    Obbligatoria · Accordo Stato-Regioni
                  </span>

                  <h1 style={{ fontSize: 'clamp(1.75rem, 3.6vw, 2.5rem)', fontWeight: 900, color: '#fff', lineHeight: 1.15, marginBottom: '1.5rem' }}>
                    {COURSE_TITLE} <span style={{ color: 'rgba(255,255,255,0.55)', fontWeight: 700 }}>(11 ore)</span>
                  </h1>
            ...
            {/* ── AREA "tabs": sistema Panoramica / Moduli / Docente ── */}
            <div className="cp-tabs-area">
              ...
              <div style={{ paddingTop: '2rem' }}>
                ...
                {activeTab === 'docente' && (
                  <div className="bg-slate-50 dark:bg-dark-bg border border-slate-200 dark:border-[rgba(255,255,255,0.08)]" style={{ borderRadius: '1.25rem', padding: '2.5rem', textAlign: 'center' }}>
                    <div style={{ width: '56px', height: '56px', borderRadius: '50%', background: 'rgba(37,211,102,0.12)', border: '1px solid rgba(37,211,102,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.25rem' }}>
                      <i className="fab fa-whatsapp" style={{ color: '#25D366', fontSize: '1.5rem' }}></i>
                    </div>
                    <h3 className="text-slate-900 dark:text-white" style={{ fontSize: '1.15rem', fontWeight: 800, marginBottom: '0.75rem' }}>
                      Vuoi iscriverti o hai bisogno di informazioni?
                    </h3>
                    <p className="text-slate-600 dark:text-gray-300" style={{ maxWidth: '420px', margin: '0 auto 1.5rem', lineHeight: 1.7 }}>
                      Contattaci su WhatsApp: ti risponderemo con tutte le informazioni su date, docenti e organizzazione del corso.
                    </p>
                    <a
