        ...
        <div className="container">
          <div className="cp-page-grid">
            ...
            <aside className="cp-price-area">
              <PricingSidebar
                priceRows={c.prezzo}
                onBuyClick={() => { addToCart({ id: `patentino-fitosanitario-${selectedTipo}`, slug: 'patentino-fitosanitario', title: c.title, variant: c.titleSuffix, price: c.prezzoNumerico }); setCartOpen(true); }}
                buyLabel="Acquista ora"
                onAddToCartClick={() => addToCart({ id: `patentino-fitosanitario-${selectedTipo}`, slug: 'patentino-fitosanitario', title: c.title, variant: c.titleSuffix, price: c.prezzoNumerico })}
              ...
              >
                ...
                {selectedTipo === 'aggiornamento' && (
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 800, color: '#008C95', whiteSpace: 'nowrap' }}>Corso Patentino · 20 ore, 130€</span>
                  </button>
                )}
              </PricingSidebar>
            </aside>
              ...
              >
                <div style={{ position: 'relative', width: '100%', height: '150px', overflow: 'hidden' }}>
                  {cc.image ? (
                    ...
                    <div style={{ width: '100%', height: '100%', background: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)' }} />
                  )}
