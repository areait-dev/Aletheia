...
const COURSE_TITLE = 'Corso di Formazione per Preposti';
const AGGIORNAMENTO_TITLE = 'Aggiornamento Formazione per Preposti';
...
export default function CorsoFormazionePreposto() {
  ...
  const corsiCorrelati = [
    { titolo: 'Aggiornamento Formazione del Preposto · 6 ore', href: '/all-courses/aggiornamento-formazione-del-preposto', image: PREPOSTO_IMAGE, meta: '6 ore · € 90,00' },
          ...
          <div className="cp-page-grid">
            ...
            <div className="cp-hero-area">
              <nav style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.78rem', marginBottom: '1.25rem', flexWrap: 'wrap' }}>
                ...
                <span className="text-slate-300 dark:text-gray-600">/</span>
                <span className="text-slate-600 dark:text-gray-300">Corso Preposto</span>
              </nav>
              ...
              <div style={{ background: 'linear-gradient(135deg, #0F172A 0%, #134E4A 100%)', borderRadius: '1.75rem', padding: 'clamp(1.75rem, 4vw, 2.75rem)', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <h1 style={{ fontSize: 'clamp(1.75rem, 3.6vw, 2.5rem)', fontWeight: 900, color: '#fff', lineHeight: 1.15, marginBottom: '1.5rem' }}>
                    Corso di Formazione per Preposti <span style={{ color: 'rgba(255,255,255,0.55)', fontWeight: 700 }}>· 12 ore</span>
                  </h1>
                ...
                {activeTab === 'moduli' && (
                  <div>
                    <h2 className="text-slate-900 dark:text-white" style={{ fontSize: '1.4rem', fontWeight: 800, marginBottom: '0.5rem' }}>
                      Programma Corso di Formazione per Preposti · 12 ore
                    </h2>
            ...
            <aside className="cp-price-area">
              ...
              >
                <Link
                  href="/all-courses/aggiornamento-formazione-del-preposto"
                  className="bg-slate-50 dark:bg-gray-700 border border-slate-200 dark:border-[rgba(255,255,255,0.08)]"
                  style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderRadius: '0.75rem', padding: '0.85rem 1rem', textDecoration: 'none' }}
                >
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.15rem' }}>
                    <span className="text-slate-700 dark:text-gray-200" style={{ fontSize: '0.8rem', fontWeight: 700 }}>Aggiornamento · 6 ore</span>
                    <span style={{ fontSize: '0.95rem', fontWeight: 800, color: '#008C95' }}>€ 90,00 + IVA</span>
                  </div>
                  <i className="fas fa-arrow-right" style={{ color: '#008C95', fontSize: '0.8rem' }}></i>
                </Link>
              </PricingSidebar>
            </aside>
          </div>
