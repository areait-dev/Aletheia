...
// attesa del programma corso ufficiale (ripartizione ore) fornito da Alètheia, per entrambe le
// configurazioni.
...
const CONTENUTO = {
  base: {
    ...
    metaDescription: 'Corso conduzione pompe per calcestruzzo, 14 ore. Attestato valido in tutta Italia. Alètheia S.r.l., Vittoria (RG).',
    schedaTecnica: [
  ...
  aggiornamento: {
    ...
    metaDescription: 'Aggiornamento conduzione pompe per calcestruzzo, 4 ore. Attestato valido in tutta Italia. Alètheia S.r.l., Vittoria (RG).',
    schedaTecnica: [
